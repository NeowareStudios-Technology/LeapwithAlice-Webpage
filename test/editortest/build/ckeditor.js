...
//   var htmlData = ClassicEditor.instances.editor.getData();
...
// editorContent.value = 'Cannot autosave, no HTML5 localStorage support';
//
// } else {
//
// // Try this
...
//     localStorage.setItem('autosave', document.querySelector('#editor').value);
//   }, 1000);
//
// } catch (e) {
//   console.log(e);
...
//   // Retrieve the item
//   document.querySelector('#editor').value = localStorage.getItem('autosave');
// }
//
// // // Clear button, onclick handler
// // document.querySelector('.clear').onclick = function() {
// // 	var result = confirm("Are you sure you want to clear your text?");
// //   if (result) {
// //   	editorContent.value = '';
...
// // 	var result = confirm("Are you sure you want to delete the storage?");
// //   	if (result) {
// //   	editor.value = '';
// //   localStorage.clear();
// // 	}
